...
- 帐号切换器
  [Account Switcher](https://lemon.qq.com/lab/app/accountswitcher.html)

Downie

Motrix
Mac上十项全能的下载软件。支持HTTP、FTP、BT、磁力链等多种格式下载。

洛雪音乐助手 mac中文版是一款非常强大的无损vip音乐下载软件
YesPlayMusic，一款高颜值的第三方网易云播放器，不仅设计精美，播放体验很优秀，而且可以听一些灰色和 VIP 的歌曲，

Pixea
是一款免费看图工具，支持GIF、Sketch、JEPG、HEIC、PSD、RAW等多种图片格式，能够显示图片的颜色直方图、EXIF、TIFF等信息，适合爱好摄影并喜欢简洁应用的用户使用。

Free Download Manager 外接程序

- TunePat Spotify Converter for Mac(Spotify音乐转换器)v1.3.1中文破解版
- TunePat Apple Music Converter for Mac(苹果音乐下载转换器)

AudioSwitcher for mac(音频切换工具)v3.03免激活版

每日英语听力——最好的英语学习类软件

Microsoft Office的模版中心